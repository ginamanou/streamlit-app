...
#                             st.write(st.session_state)
#                             if selected_lvdt== "":#all_lvdts_for_plot[selected_exp] == "":
#                                 st.markdown(":red[**Attention!!**] You haven't selected a LVDT to plot. Revise your inputs in the **Data entry** in order to continue.")
#                             elif all_lvdts_for_plot[selected_exp] == 'LVDT 1':
#                                 var = 'strain1'
